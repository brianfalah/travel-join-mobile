...
public class DynamicListView extends ListView {
    ...
    public ArrayList<GeneralItem> mList;
    ...
    private void swapElements(ArrayList<GeneralItem> arrayList, int indexOne, int indexTwo) {
        GeneralItem temp1 = arrayList.get(indexOne);
        GeneralItem temp2 = arrayList.get(indexTwo);
        //updateOrder(indexOne + 1,temp2);
        //updateOrder(indexTwo + 1,temp1);
	...
	//private void updateOrder(int index, GeneralItem temp) {
		//((TourPoi) temp).setOrderNumber(index);
